...
export default function Dashboard() {
  ...
  function countValues() {
    ...
    return { total_days: total_number_of_days, average_mood: Math.round(sum_moods / total_number_of_days) || 0 }
  }
  ...
  return (
    <div className='flex flex-col flex-1 gap-8 sm:gap-12 md:gap-16 '>
      <div className='grid grid-cols-3 bg-indigo-50 text-indigo-500 p-4 gap-4 rounded-lg place-items-center'>
